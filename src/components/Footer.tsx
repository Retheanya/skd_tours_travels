    ...
    <>
      ...
      <section className="relative w-full h-[600px] md:h-[800px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center space-y-8 px-4">
          ...
          <div>
            <Link to="/contact" className="inline-block bg-[#f97316] hover:bg-[#ea580c] text-white px-10 py-4 rounded-md font-bold text-lg uppercase transition-all shadow-xl hover:scale-105 active:scale-95 select-none cursor-pointer">
              Book Now
            </Link>
          </div>
        </div>

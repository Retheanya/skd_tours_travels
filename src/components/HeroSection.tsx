...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-[600px] h-screen lg:h-[calc(100vh-86.2px)] w-full overflow-hidden bg-[#0a0a0a]">
      {/* SVG FILTERS */}
      ...
      <div className="relative z-10 w-full h-full flex flex-col items-center justify-center pointer-events-none px-4 pb-32 lg:pb-0">
          <div className="max-w-5xl mx-auto text-center space-y-4">
              <div className="flex items-center justify-center gap-2 md:gap-4 animate-fade-in-up [animation-delay:0.2s]">
                  <span className="text-white text-xs md:text-lg tracking-widest hidden sm:inline">★ ★ ★</span>
                  <h2 className="m-0 p-0 text-[20px] md:text-[25px]">
                    {slides[selectedIndex].badge}
                  </h2>
                  <span className="text-white text-xs md:text-lg tracking-widest hidden sm:inline">★ ★ ★</span>
              </div>
              <h1 className="drop-shadow-2xl animate-fade-in-up [animation-delay:0.5s] text-white text-[32px] sm:text-[40px] md:text-[60px] lg:text-[72px] leading-tight">
                {slides[selectedIndex].title}
              </h1>
              <p className="text-base md:text-xl text-white/90 max-w-2xl mx-auto italic animate-fade-in-up [animation-delay:0.8s] mt-2" style={{ fontFamily: "'Jost', sans-serif" }}>
      ...
      <div className="absolute bottom-0 left-0 right-0 z-40 pointer-events-none overflow-hidden h-20 md:h-32">
      ...
      {/* 6. BOTTOM DATA BAR */}
      <div className="absolute bottom-0 left-0 right-0 z-50 px-4 md:px-8 pb-0">
          <div className="container mx-auto flex flex-col lg:flex-row items-center lg:items-end justify-between gap-4">
              
              <div className="hidden md:flex items-center gap-3 mb-4 lg:mb-14 animate-fade-in-up [animation-delay:1.5s] pointer-events-auto">
              ...
              <div className="w-full max-w-4xl translate-y-0 lg:translate-y-6 animate-fade-in-up [animation-delay:1.8s] pointer-events-auto mb-4 lg:mb-0">
                  <div className="bg-white rounded-[1.5rem] lg:rounded-t-[2rem] lg:rounded-b-none shadow-2xl flex flex-col md:flex-row items-stretch overflow-hidden border border-gray-100">

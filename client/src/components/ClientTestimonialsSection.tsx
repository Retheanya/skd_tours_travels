  ...
  return (
    <section className="py-12 bg-white relative overflow-hidden">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center gap-8 relative min-h-[500px] max-w-7xl mx-auto px-10">
          {/* Left Arrow (Universal Positioning) */}
          <button 
            onClick={handlePrev}
            className="absolute left-0 md:left-[-15px] lg:left-[-30px] top-1/2 -translate-y-1/2 z-30 transition-transform hover:scale-110 active:scale-95"
          >
            <img src={leftArrow} alt="Previous" className="w-[45px] h-[45px] md:w-[70px] md:h-[70px] lg:w-[100px] lg:h-[100px] object-contain" />
          </button>

          {/* Right Arrow (Universal Positioning) */}
          <button 
            onClick={handleNext}
            className="absolute right-0 md:right-[-15px] lg:right-[-60px] top-1/2 -translate-y-1/2 z-30 transition-transform hover:scale-110 active:scale-95"
          >
            <img src={rightArrow} alt="Next" className="w-[45px] h-[45px] md:w-[70px] md:h-[70px] lg:w-[100px] lg:h-[100px] object-contain" />
          </button>

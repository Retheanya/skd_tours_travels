...
const GallerySection = () => {
  return (
    <section className="min-h-screen pt-12 pb-20 bg-white relative overflow-hidden flex flex-col justify-center">
      ...
      <div className="absolute right-2 md:right-12 top-2 md:top-12 w-16 sm:w-28 md:w-80 z-0 pointer-events-none opacity-40 md:opacity-80">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col gap-6 items-center">
          ...
          <div className="flex flex-wrap justify-center items-center gap-4 sm:gap-6">
            <div className="w-[130px] sm:w-[150px] h-[130px] sm:h-[150px] rounded-2xl overflow-hidden shadow-lg mt-0 sm:mt-8">
              <img src={img1} className="w-full h-full object-cover" alt="Gallery 1" />
            </div>
            <div className="w-[200px] sm:w-[230px] h-[190px] sm:h-[220px] rounded-2xl overflow-hidden shadow-xl z-20">
              <img src={img2} className="w-full h-full object-cover" alt="Gallery 2" />
            </div>
            <div className="w-[130px] sm:w-[150px] h-[130px] sm:h-[150px] rounded-2xl overflow-hidden shadow-lg mt-0 sm:mt-10">
              <img src={img3} className="w-full h-full object-cover" alt="Gallery 3" />
            </div>
            <div className="w-[90px] sm:w-[100px] h-[90px] sm:h-[100px] rounded-2xl overflow-hidden shadow-lg mb-0 sm:mb-8">
              <img src={img4} className="w-full h-full object-cover" alt="Gallery 4" />
            </div>
          </div>

          {/* Row 2: Bottom 4 */}
          <div className="flex flex-wrap justify-center items-start gap-4 sm:gap-6 -mt-2">
            <div className="w-[130px] sm:w-[150px] h-[130px] sm:h-[150px] rounded-2xl overflow-hidden shadow-lg transform translate-y-0 sm:translate-y-2">
              <img src={img5} className="w-full h-full object-cover" alt="Gallery 5" />
            </div>
            <div className="w-[130px] sm:w-[150px] h-[130px] sm:h-[150px] rounded-2xl overflow-hidden shadow-lg transform translate-y-0 sm:-translate-y-4">
              <img src={img6} className="w-full h-full object-cover" alt="Gallery 6" />
            </div>
            <div className="w-[200px] sm:w-[230px] h-[190px] sm:h-[220px] rounded-2xl overflow-hidden shadow-xl transform translate-y-0 sm:translate-y-4">

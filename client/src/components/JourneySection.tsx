        ...
        <div className="space-y-6 relative px-4 lg:px-8">
          ...
          <div className="pt-4">
              <button 
                ...
                className="bg-[#f97316] hover:bg-[#222] text-white px-8 py-3.5 rounded-md font-bold transition-all duration-300 text-[15px] cursor-pointer hover:scale-105 active:scale-95"
              >
                More About
              </button>
          </div>
